...
st.write(
    ...
    " Deteksi mungkin belum tepat jika menggunakan sample yang salah, karena identifikasi masih menggunakan bentuk (untuk menghemat GPU server), akan lebih akurat jika telah memanfaatkan machine learning (boros GPU server - dibatasi)."
)
